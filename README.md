...
# Evaluate Payday Super compliance via CLI
uvx --from git+https://github.com/ryanduguid/CharlesHenryWickens.git payday-super --help
```
...
- **[aus-accounting-mcp](https://github.com/ryanduguid/aus-accounting-mcp)** (`JohnKenley`) - Unified Model Context Protocol (MCP) server exposing ATO small business benchmarks, Payday Super statutory timelines, and synthetic SBR test payloads to Claude Desktop, Claude Code, Cursor, and Antigravity.
...
- **[payday-super-checker](https://github.com/ryanduguid/payday-super-checker)** (`CharlesHenryWickens`) - Deterministic engine evaluating Australian Payday Super 2026 contribution timelines and Superannuation Guarantee (SG) charge exposure on late remittances.
